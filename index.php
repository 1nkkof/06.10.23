...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = sprintf(
        "SELECT * FROM `bd_connect` WHERE email= '%s'",
                    ...
                    <section class="main-form">
                        <div class="big-container">
                            ...
                            <div class="main-form__container">
                                ...
                                <form method="post">
                                    <input type="text" name="email" placeholder="Введите email:" class="input-name"
                                        value="<?= htmlspecialchars($_POST["email"] ?? "") ?>" id="email">
                                    <input type="password" name="password" placeholder="Введите пароль:" id="password" class="input-password">
