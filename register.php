                        ...
                        <div class="main-form__container">
                            <form action="/vendor/signup.php" method="post" novalidate class="signup" autocomplete="off">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name"  class="input-name"  placeholder="Имя:">
                                </div>
                                <div>
                                  
                                    <input type="email" placeholder="Почта email:" class="input-email" name="email" id="email">
                                </div>
                            
                                <input type="password" placeholder="Пароль:" class="input-password" name="password" id="password">
                                <div>
                                   
                                    <input type="password"  placeholder="Повторите пароль"  class="input-password-again" name="password_confirmation" id="password_confiramtion">
                                </div>
                                    <!-- ДАША НЕ ТРОГАЙ 55 строчку  -->
                                 <input type="hidden" name="status" id="status">
                                <button class="big-container__button">зарегистрироваться</button>
                            </form>
                        </div>
