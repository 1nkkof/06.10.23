...
<body>
    <div class="wrapper">
        <header class="container">
            ...
            <nav class="menu">
        <div class="menu-logo">
            <a href="guestPage.php" class="nav-menu__logo"><img src="images/logo.svg" alt="logo" class="logo-header"></a>
        </div>
        ...
        <div class="row">
                             ...
                             <div class="result-box">
                                 <!-- тут должны быть блоки с контентом  -->
                             </div>
                         </div>
        </div>
        <div class="menu-link">
            ...
            <a href="#">Каталог</a>
            <div class="menu-shop">
                <img src="/images/basket-shop.svg" alt="basket-shop">
            </div>
            <div class="menu-link__ex">
<div class="menu-user" onclick="openbox('box'); return false">
                <a href=""><img src="/images/user-img.svg" alt="" class="menu-user__img"></a>
        
                
            </div>
            <a href="mainPage.php" class="text" id="box" style="display: none;">Выйти</a>
            </div>
